...
public class Topic14_02_DowloadFiles {
	WebDriver driver;
	...
	public void TC_01_DownloadFile() {
		//driver.get("https://gofile.io/d/evuDeG");
		//driver.findElement(By.xpath("//span[@class='contentName' and text()='name01.jpg']")).click();

		driver.get("https://unsplash.com/photos/3eHdk6dPY3U");
